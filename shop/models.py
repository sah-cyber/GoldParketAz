...
class Shop(models.Model):
    ...
    slug = models.SlugField(max_length=100,unique=True,null=True)
    categoriya = models.ForeignKey(Category, blank=True, null=True, on_delete=models.CASCADE, verbose_name='Categoriya',default='Secim edin')
    contry = models.ForeignKey(Contry,blank=True,null=True, on_delete=models.CASCADE,verbose_name='Olke',default='Secim edin')
